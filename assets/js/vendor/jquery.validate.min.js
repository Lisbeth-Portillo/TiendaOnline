...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = a(require("jquery")) : a(jQuery) }(function(a) {
    a.extend(a.fn, {
        ...
        messages: { required: "Este campo es requerido.", remote: "Por favor arregla este campo.", email: "Por favor, introduce una dirección de correo electrónico válida.", url: "Por favor introduzca un URL válido.", date: "Por favor introduzca una fecha valida.", dateISO: "Introduzca una fecha válida (ISO).", number: "Por favor ingrese un número valido.", digits: "Por favor ingrese solo dígitos.", equalTo: "Por favor, introduzca el mismo valor de nuevo.", maxlength: a.validator.format("No ingrese más de {0} caracteres."), minlength: a.validator.format("Ingrese al menos {0} caracteres."), rangelength: a.validator.format("Introduzca un valor de entre {0} y {1} caracteres."), range: a.validator.format("Ingrese un valor entre {0} y {1}."), max: a.validator.format("Ingrese un valor menor o igual que {0}."), min: a.validator.format("Ingrese un valor mayor o igual que {0}."), step: a.validator.format("Ingresa un múltiplo de {0}.") },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
                function b(b) {
