...
(function($) {
    ...
    ///Funcion del header a cierta altura
    ...
    //Funcion para el desplazamiento del head
    ...
    //Presentación de diapositivas de la página de inicio del slider
    ...
    // Banner de tamaño completo en cualquier pantalla
    ...
    /*-------------------------------
      16. Animación del sitio
    ----------------------------------*/
    if ($(window).width() < 771) {
        $('.wow').removeClass('wow');
    }
    var wow = new WOW({
        boxClass: 'wow', // nombre de la clase que revela el cuadro oculto cuando el usuario se desplaza.
        animateClass: 'animated', //nombre de la clase que activa las animaciones CSS ('animada' por defecto para la biblioteca animate.css)
        offset: 0, // Defina la distancia entre la parte inferior de la ventana del navegador y la parte superior del cuadro oculto.Cuando el usuario se desplaza y alcanza esta distancia, se revela el cuadro oculto.
        mobile: false, //enciende / apaga wow.js en dispositivos móviles.
        live: true, //compruebe constantemente si hay nuevos elementos WOW en la página.
        ...
        scrollContainer: null // selector de contenedor de desplazamiento opcional, de lo contrario use window
    });
    wow.init();
    ...
    /* Conteo de fecha limite de descuento*/
